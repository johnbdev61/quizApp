const store = {
    questions: [{
        ...
        {
            question: 'Who WAS NOT considered to play the staring role of John McClane?',
            answers: [
                'Clint Eastwood',
                'Frank Sinatra',
                'Charles Bronson',
...
function renderStartTemplate() {
    return `
    <div class ="project-card project-card:hover"><form class="flex-column flex-center">
        ...
        <div><button class="start-button" type="button">Start Quiz!</button></div>
    </form>`;
}
...
function renderQuestionTemplate() {
    ...
    <div class ="project-card project-card:hover"><form class="flex-column flex-center">
        ...
        <div class="submit-question-btn"><button class='submit-question-button error-checker' type='submit'>Submit Question!</button></div> 
        <div>
            <h3>Current Score</h3>
...
function renderAnswerTemplate() {
    ...
    <div class ="project-card project-card:hover"><form class="flex-column flex-center">
        ...
        <div class="next-question-btn"><button class='next-question-button' type='submit'>Next Question</button></div>
        <div>
            <h3>Current Score</h3>
            <span>Correct Answers: ${store.score} / Incorrect Answers: ${store.incorrect} </span> 
        </div>
...
function renderQuizEndTemplate() {
    ...
    <p class="end-p">Thanks for taking our quiz! This information will be sold to REDACTED SOCIAL MEDIA COMPANY to help better target adds to users like you.</p>
    <p class="end-p">Feel free to take it again to give us more data to better fit your consumption needs!</p>    
    <div class="try-again"><button type="submit" class="try-again-button">Try Again!</button></div>
    </form></div>`;
}
